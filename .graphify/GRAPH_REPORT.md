...
## Corpus Check
- Large corpus: 241 files · ~221.866 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1987 nodes · 4275 edges · 41 communities detected
...
- Included files: 241 · Candidates: 501
- Excluded: 5 untracked · 36811 ignored · 1 sensitive · 1 missing committed
...
Cohesion: 0.01
Nodes (342): a5(), addEventListener(), addRoute(), AF(), AI(), Ap(), aT(), ax() (+334 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (56): AnalyticsPage(), isoDate(), monthStart(), AttendancePage(), compactDateWithDay(), formatMinutesToHours(), formatTargetSource(), normalizeDateKey() (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (126): calculateBradfordFactors(), calculateCheckInDistribution(), calculateDepartmentBreakdown(), calculateHeatmap(), calculateMetrics(), calculateWeeklyTrend(), GET(), getDayCount() (+118 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (19): _7, DM(), ej(), G5, hP, lQ, mh(), "node_modules/node-forge/lib/mgf.js"() (+11 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (25): AV, ay(), cu(), dv(), EV, Fv(), Gv(), IQ (+17 more)
...
Cohesion: 0.04
Nodes (58): _9(), activeFileDelete(), activeFileGet(), activeFilePatch(), activeFilePost(), activeFilePut(), authenticationMiddleware(), certificateGet() (+50 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (30): attributeChangedCallback(), connectedCallback(), cT(), D3, $$g_p(), j4(), J7(), Jt() (+22 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (33): buildQuickSummariesMetadataRows(), buildQuickSummariesTableColumns(), cellCountByDate(), cellTextByDate(), computeTotalPunches(), normalizeDateKeys(), normalizedGroupName(), numberOrZero() (+25 more)
...
Cohesion: 0.12
Nodes (34): getMigrationGateStatus(), normalizeEnumValue(), resolveDataSourceCutoverMode(), resolveMachineParityExposureMode(), resolveMigrationFlags(), resolveMode(), resolvePolicySourceMode(), resolveReportingInteractionMode() (+26 more)
...
Cohesion: 0.08
Nodes (7): bN(), disconnectedCallback(), Iv(), lj(), OV, Ph(), uH

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (28): a4, aK(), BT(), ck(), CX(), dT(), DZ(), ET() (+20 more)
...
- **Thin community `Community 19`** (1 nodes): `Jh()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `o8`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `H9`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (2 nodes): `GET()`, `jsonResponse()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (2 nodes): `buildHopBStatusResponse()`, `readHopBIngestStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `z9` connect `Community 3` to `Community 0`, `Community 7`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `_7` connect `Community 3` to `Community 0`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `G5` connect `Community 3` to `Community 0`?**
