...
<div class="row">
	...
	<div class="col-sm-4"><input type="submit" class="btn btn-primary btn-block" name="b_DelUser" value="Delete All User" disabled></div>
...
<div class="row">
	...
	<div class="col-xs-6"><input type="submit" class="btn btn-primary btn-block" name="b_SetUser" value="Set User" style="width:133px" disabled></div></div>
	
	
	<div class="col-sm-4"><div class="col-xs-6"><input type="text" class="form-control" placeholder="PIN" name="i_delUser" style="width:120px" disabled></div>
	<div class="col-xs-6"><input type="submit" class="btn btn-danger btn-block" name="b_delUserPIN" value="Delete User Pin" style="width:133px" disabled></div></div>
	
	<div class="col-sm-4"><input type="submit" class="btn btn-danger btn-block" name="b_delUserDB" value="Clear User in Database" disabled></div>
