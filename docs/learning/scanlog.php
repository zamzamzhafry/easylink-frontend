...
<form method="post" action="index.php?m=content&p=scanlog">
	<div class="row">
			...
			<div class="col-sm-2"><input type="submit" class="btn btn-primary btn-block" name="b_allScan" value="Get All Scanlog" style="width:133px"></div>
			...
			<div class="col-sm-2"><input type="submit" class="btn btn-danger btn-block" name="b_delScan" value="Delete Scanlog" style="width:133px" disabled></div>
			<div class="col-sm-2"><input type="submit" class="btn btn-danger btn-block" name="b_delScanDB" value="Clear Scanlog DB" style="width:133px" disabled></div>
