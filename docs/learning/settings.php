...
<form method="post" action="index.php?m=content&p=settings">
	...
	<div class="col-sm-4">
		...
		<input type="submit" class="btn btn-danger btn-block" name="b_delAdm" value="Delete Admin">
		<input type="submit" class="btn btn-danger btn-block" name="b_delLog" value="Delete Device Log">
		<input type="submit" class="btn btn-danger btn-block" name="b_init" value="Initialization">
	</div>
</form>
